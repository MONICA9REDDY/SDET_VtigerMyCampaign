...
public class TestCase_15_AdvancedSearchForSecondDpDn extends Baseclass{
	
	@Test
	public void MyCampaigns_AdvancedSearchForSecondDpDn() throws EncryptedDocumentException, InvalidFormatException, IOException {
		...
		wdu.selectdropdown1(cp.getInDDL(),cp.getInDDL2());
